...
The project is experimental. The first release was `0.1.0-alpha`; the current development build is `0.2.7-alpha.3`, focused on broker-grant hardening before token vending, picker flows, or GitHub App credentialed publishing.
